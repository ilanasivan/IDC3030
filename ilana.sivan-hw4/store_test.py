...
class TestStoreTest:
    ...
    @pytest.mark.search
    def test_lexical_sort_with_empty_shopping_cart_search_by_name(self, store):
    ...
    @pytest.mark.search
    def test_lexical_sort_with_empty_shopping_cart_and_search_for_item(self, store):
        search_phrase = 'the '
    ...
    @pytest.mark.search
    def test_search_hashtag_empty_shopping_cart(self, store):
        hashtag = 'Technology'
    ...
    @pytest.mark.search
    def test_search_no_existing_hashtag(self, store):
        assert len(store.search_by_hashtag('qqq')) == 0


    @pytest.mark.search
    def test_search_no_existing_name(self, store):
        assert len(store.search_by_name('qqq')) == 0


    @pytest.mark.search
    def test_sort_with_shopping_cart_example(self, store):
    ...
    @pytest.mark.search
    def test_sort_with_hashtag_search_non_empty_cart(self, store):
        store.add_item('Bbbb')
    ...
    def test_checkout_empty_shopping_cart(self, store):
        assert store.checkout() == 0


    @pytest.mark.checkout
    def test_correct_total(self, store):
    ...
    @pytest.mark.remove
    def test_remove_non_existing_item(self, store):
        with pytest.raises(ItemNotExistError):
            store.remove_item('some_name')


    @pytest.mark.remove
    def test_remove_item_with_too_generic_name(self, store):
    ...
    @pytest.mark.add
    @pytest.mark.checkout
    def test_add_and_remove_same_item(self, store):
    ...
    @pytest.mark.add
    def test_add_item_twice(self, store):
    ...
    @pytest.mark.add
    def test_add_item_with_too_generic_name(self, store):
        with pytest.raises(TooManyMatchesError):
            store.add_item('')


    @pytest.mark.add
    def test_add_non_existing_item(self, store):
        with pytest.raises(ItemNotExistError):
